<div class="width">
    <div class="container">
        ...
        <ul class="summary">
            ...
            <li>Can be used for creating <em>unlimited</em> applications</li>
        ...
        <a href="page/licensing-options">For more information on the license summary topics</a>
    </div>
    <div class="container terms">
        <h2>Sportaneous - Terms and conditions</h2>
        <ol>
            <li>
                <p><strong>Preamble:</strong> This Agreement, signed on Jan 14, 2018 (hereinafter: Effective Date) governs the relationship between All Business and Individual Entity, (hereinafter: Licensee) and Collabrators of this application (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Sportaneous (hereinafter: The Software) created and owned by Licensor, as detailed herein</p>
            </li>
            <li>
